...
class StreamResultOfApiGetDocumentResponse(BaseModel):
    """
    StreamResultOfApiGetDocumentResponse
    """ # noqa: E501
    result: Optional[ApiGetDocumentResponse] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": ApiGetDocumentResponse.from_dict(obj["result"]) if obj.get("result") is not None else None,
