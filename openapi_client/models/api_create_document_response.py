...
class ApiCreateDocumentResponse(BaseModel):
    """
    ApiCreateDocumentResponse
    """ # noqa: E501
    metadata: Optional[ApiDataMetadata] = Field(default=None, alias="Metadata")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Metadata": ApiDataMetadata.from_dict(obj["Metadata"]) if obj.get("Metadata") is not None else None
        })
        return _obj
